...
const GeneradorComunicados = () => {
  ...
  // Este componente ya no se usa, lo he eliminado
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-gray-800/90 backdrop-blur-lg rounded-2xl p-4 shadow-2xl border border-gray-700/50 sticky top-8">
              <h2 className="text-xl font-bold bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent flex items-center gap-2 mb-4">
              ...
              <div className="space-y-4">
                ...
                <div className="border border-gray-700/50 rounded-lg p-3">
                  <h3 className="text-sm font-semibold text-gray-400 mb-2 flex items-center uppercase tracking-wider">
                    <AlertCircle className="w-4 h-4 mr-1.5 text-yellow-400" />
                    Eventos
                  </h3>
                  <div className="grid grid-cols-3 gap-2">
                    <button
                      className={`flex flex-col items-center p-2 rounded-lg transition-all duration-300 ${
                        tipo === 'evento-inicio'
                          ? 'bg-yellow-600/90 text-white shadow-lg shadow-yellow-600/30'
                ...
                <div className="border border-gray-700/50 rounded-lg p-3">
                  <h3 className="text-sm font-semibold text-gray-400 mb-2 flex items-center uppercase tracking-wider">
                    <Wrench className="w-4 h-4 mr-1.5 text-orange-400" />
                    Mantenimientos
                  </h3>
                    ...
                    <button
                      className={`flex flex-col items-center p-2 rounded-lg transition-all duration-300 ${
                        tipo === 'mantenimiento-inicio'
                          ? 'bg-orange-600/90 text-white shadow-lg shadow-orange-600/30'
                          : 'bg-gray-700/50 text-gray-300 hover:bg-gray-700/70'
                      }`}
                    ...
                    <button
                      className={`flex flex-col items-center p-2 rounded-lg transition-all duration-300 ${
                        tipo === 'incidente-inicio'
                          ? 'bg-red-600/90 text-white shadow-lg shadow-red-600/30'
                          : 'bg-gray-700/50 text-gray-300 hover:bg-gray-700/70'
                      }`}
