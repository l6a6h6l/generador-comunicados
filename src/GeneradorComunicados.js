...
const GeneradorComunicados = () => {
  ...
  useEffect(() => {
    calcularDuracion();
  }, [fechaInicioFin, horaInicioFin, fechaFin, horaFin, calcularDuracion]);
  ...
  const copiar = () => {
    ...
    // Usar la API del portapapeles o fallback
      ...
      <div className="max-w-4xl mx-auto p-4">
        ...
        <div className="bg-gray-900 bg-opacity-80 rounded-lg p-6 mb-8 shadow-lg border border-white border-opacity-10">
          ...
          <div className="flex flex-wrap gap-2 mb-6">
            <div 
              className={`flex-1 min-w-md text-center p-3 rounded-lg cursor-pointer transition ${tipo === 'evento-inicio' ? 'bg-green-600 border-green-600 text-white' : 'bg-gray-800 border border-white border-opacity-20 text-gray-300'}`}
            ...
            <div 
              className={`flex-1 min-w-md text-center p-3 rounded-lg cursor-pointer transition ${tipo === 'evento-seguimiento' ? 'bg-green-600 border-green-600 text-white' : 'bg-gray-800 border border-white border-opacity-20 text-gray-300'}`}
            ...
            <div 
              className={`flex-1 min-w-md text-center p-3 rounded-lg cursor-pointer transition ${tipo === 'evento-fin' ? 'bg-green-600 border-green-600 text-white' : 'bg-gray-800 border border-white border-opacity-20 text-gray-300'}`}
            ...
            <div 
              className={`flex-1 min-w-md text-center p-3 rounded-lg cursor-pointer transition ${tipo === 'mantenimiento-inicio' ? 'bg-green-600 border-green-600 text-white' : 'bg-gray-800 border border-white border-opacity-20 text-gray-300'}`}
            ...
            <div 
              className={`flex-1 min-w-md text-center p-3 rounded-lg cursor-pointer transition ${tipo === 'mantenimiento-fin' ? 'bg-green-600 border-green-600 text-white' : 'bg-gray-800 border border-white border-opacity-20 text-gray-300'}`}
